...
![physical footprint of DGX spark vs RTX 4090 Deep Learning PC](images/deep-learning-pc-and-dgx-spark-footprint.png)
...
* Create a Python 3.12 virtual environment (can use [`conda`](https://www.anaconda.com/docs/getting-started/miniconda/install) or [`uv`](https://docs.astral.sh/uv/getting-started/installation/#standalone-installer) if you want) and install dependencies:
...
* Install `llama.cpp` - https://github.com/ggml-org/llama.cpp/blob/master/docs/install.md
    * Setup llama server - https://github.com/ggml-org/llama.cpp/discussions/16938
